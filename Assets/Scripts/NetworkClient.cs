...
public class NetworkClient : MonoBehaviour
{
    ...
    {
        NetworkMessage networkMessage = new NetworkMessage("W", _playerSessionId);
        Send(networkMessage);
    }
    ...
    {
        Debug.Log($"NetworkClient ConnectToServer {ip}, {port}, {playerSessionId}");
