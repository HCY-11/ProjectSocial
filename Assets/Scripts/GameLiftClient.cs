...
public class GameLiftClient
{
   ...
   private string FleetId = "fleet-7627153e-58cb-422b-a1e3-15369d98c097"; // TODO: probably don't hardcode this, use alias or something
   ...
   async private void CreatePlayerSession(GameSession gameSession)
   {
      ...
      if (playerSession != null)
      {
         ...
         _NetworkClient.ConnectToServer(playerSession.IpAddress, playerSession.Port, playerSession.PlayerSessionId);
      }
   ...
   async private void setup()
   {
      ...
      _NetworkClient = GameObject.FindObjectOfType<NetworkClient>();
